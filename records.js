...
function renderRecordsList() {
  ...
  container.innerHTML = visitRecords
    ...
    <div class="bg-slate-800 border border-slate-700 p-4 rounded-xl flex justify-between items-center shadow-sm">
        ...
        ${
          rec.phone
            ? `<a href="tel:${rec.phone}" class="bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-2 rounded-lg flex items-center justify-center font-bold text-xs active:scale-95 transition">📞 Call</a>`
            : ""
        }
    </div>
`
